...
import com.giftpunding.osds.databinding.FragmentFundingListBinding
import com.giftpunding.osds.ui.funding.adapter.FundingListMyItemAdapter

class FundingListFragment : Fragment() {
    ...
    fun init() {
        val tempList = listOf<FundingCompleteResponse>(
            FundingCompleteResponse("img", "brand", "name", 10000)
        )
    ...
    companion object {
        ...
        fun getFragmentInstance(): Fragment? {
            fragmentListFragment = FundingListFragment()
